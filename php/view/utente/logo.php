<div class="page-header navbar navbar-fixed-top">
	...
	<div class="page-header-inner container">
		<div class="page-logo">
			<a href="utente"> <img src="../assets/img/logo.png" alt="logo"
				...
				<ul class="nav navbar-nav pull-right">
					<li class="dropdown dropdown-user"><a href="javascript:;"
						...
						data-hover="dropdown" data-close-others="true"> <span
							class="username username-hide-on-mobile"> Opzioni Utente</span> <i
					...
					<div class="row">
						...
						<div class="col-md-4">
							<input id="nome" name="nome" type="text" class="form-control"
								value="<?=$clu->getNome ();?>"> <input name="cmd" type="hidden"
								value="mydata">
						</div>
						<div class="col-md-2">
							<label>Cognome</label>
					...
					<div class="row">
						...
						<div class="col-md-4">
							<input id="indirizzo" name="indirizzo" type="text"
								class="form-control" value="<?=$clu->getIndirizzo ();?>">
						</div>
					</div>
					<div class="row">
						<div class="col-md-2">
